...
# path = "/Users/fighting/PycharmProjects/Text_error_detection/correctionData/ctrain_sighan14.txt"
# # read_text_path = '../data/public_simple_data/test1_text'
# train_texts = get_text(path)
# train_texts = Simplified2Traditional(train_texts)
...
path = "../data/public_data/public_test1_text"
read_text_path = '../data/public_simple_data/test1_text'
train_texts = get_text(path)
train_texts = Simplified2Traditional(train_texts)
with open(read_text_path, 'w') as w:
    for sen in train_texts:
        w.write(sen)
        w.write('\n')
